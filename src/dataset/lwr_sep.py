...
class LwrSepLoader():
    ...
    def load_data(self):
        ...
        rho_x_t = np.loadtxt(os.path.join("data", "lwr_sep", "rho_sep_rmin=0.4rmax=0.6sigma=0.2.csv"), delimiter=',')
        V_x_t = np.loadtxt(os.path.join("data", "lwr_sep", "V_sep_rmin=0.4rmax=0.6sigma=0.2.csv"), delimiter=',')
        u_x_t = np.loadtxt(os.path.join("data", "lwr_sep", "u_sep_rmin=0.4rmax=0.6sigma=0.2.csv"), delimiter=',')
