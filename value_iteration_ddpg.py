...
from utils import get_rho_from_u, get_rho_network_from_u, train_rho_network_one_step, plot_3d, plot_diff
...
def train_ddpg(reward, n_cell, T_terminal, d, iterations, fake_critic, surf_plot, smooth_plot, diff_plot):
    delta_T = 1 / n_cell
    ...
    for it in range(iterations):
        ...
        n_actor_train_loop = 1 if reward == "non-sep" else 2000
        if reward == 'lwr':
        ...
        n_rho_train_loop = 100 if reward == "non-sep" else 2000
